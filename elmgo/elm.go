...
type Elmable[Model any, Msg any, Renderable any] interface {
	Init() Model
	// To be generally useful this should probably return a pointer of Cmd so it can be nil rather than
	// forcing a pull in of this dependency.
	Update(Msg, Model) (Model, option.Option[Cmd])
